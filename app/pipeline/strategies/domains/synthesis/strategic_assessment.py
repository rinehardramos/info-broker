"""Strategic assessment synthesis sub-strategy module."""

CATEGORY = "synthesis"
NAME = "strategic_assessment"
DISPLAY_NAME = "Strategic Assessment"
DESCRIPTION = (
    "Comprehensive strategic analysis using a multi-framework cascade: "
    "PESTLE → Porter's Five Forces → SWOT → VRIO. Each framework builds on "
    "the prior one. Stakeholder perspectives are incorporated before conclusions."
)
SELECTORS = [
    "strategic_entity",
    "industry_context",
