"""Systematic review synthesis sub-strategy module."""

CATEGORY = "synthesis"
NAME = "systematic_review"
DISPLAY_NAME = "Systematic Review"
DESCRIPTION = (
    "Rigorous systematic review following a PRISMA-like protocol: exhaustive search, "
    "transparent deduplication, GRADE quality grading, and meta-synthesis. The output "
    "is reproducible — search strategy is documented in full."
)
SELECTORS = [
    "research_question",
    "eligibility",
