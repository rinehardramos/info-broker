"""Due diligence retrieval sub-strategy module."""

CATEGORY = "retrieval"
NAME = "due_diligence"
DISPLAY_NAME = "Due Diligence"
DESCRIPTION = (
    "Compliance-grade investigation supporting KYC, AML, and M&A due diligence. "
    "Traces beneficial ownership, screens against sanctions/PEP lists, and "
    "requires two independent sources for every material fact."
)
SELECTORS = [
    "full_name",
    "date_of_birth",
