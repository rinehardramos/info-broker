"""Academic researcher retrieval sub-strategy module."""

CATEGORY = "retrieval"
NAME = "researcher"
DISPLAY_NAME = "Academic Researcher"
DESCRIPTION = (
    "Maps the scholarly identity and output of an academic researcher: complete "
    "publication record, institutional affiliations, research network, and citation "
    "impact. Anchors on academic indices before expanding the citation graph."
)
SELECTORS = [
    "full_name",
    "employer",
