"""Company investigation retrieval sub-strategy module."""

CATEGORY = "retrieval"
NAME = "company"
DISPLAY_NAME = "Company Investigation"
DESCRIPTION = (
    "Maps a company's legal identity, digital infrastructure, leadership team, "
    "financial standing, competitive position, and technology stack. Anchors on "
    "the registered legal entity before expanding to adjacent selectors."
)
SELECTORS = [
    "domain",
    "employer",
