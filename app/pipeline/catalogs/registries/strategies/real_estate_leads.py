...
STRATEGY = build_research_strategy(
    ...
    gather={
        ...
        "briefing": (
            ...
            "  c. PUBLIC RECORDS for the OWNER: web_search '<address> county assessor OR "
            "     recorder OR parcel search owner', then property_records_lookup "
            "     (run_web_crawl) on that county/parcel URL for the OWNER OF RECORD name + "
            "     mailing address — the authoritative free owner identity (phone rarely "
            "     present, but the NAME + mailing address are).\n"
