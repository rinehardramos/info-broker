...
STRATEGY = build_research_strategy(
    ...
    gather={
        ...
        "briefing": (
            ...
            "  a. SCRAPE THE LISTING: for each listing, use listing_detail_scrape "
            "     (fetch_content=true) on the address/listing — the detail page itself "
            "     usually shows the listing agent's name + phone + a contact form, and "
            "     FSBO pages show the owner directly. Extract name/phone/email from the "
            "     fetched page text.\n"
