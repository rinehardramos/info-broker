...
VALUES
    ('00000000-0000-8000-8000-000000000011', '00000000-0000-8000-8000-000000000001', 'agent_input',    'Agent CLI',      '{}', 0, 0),
    ('00000000-0000-8000-8000-000000000012', '00000000-0000-8000-8000-000000000001', 'ddg_search',     'DDG Search',     '{}', 0, 1),
    ('00000000-0000-8000-8000-000000000013', '00000000-0000-8000-8000-000000000001', 'manual_scoring', 'Manual Scoring', '{}', 0, 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO pipeline_edges (id, pipeline_id, source_node_id, target_node_id, edge_type)
VALUES
    ('00000000-0000-8000-8000-000000000021', '00000000-0000-8000-8000-000000000001', '00000000-0000-8000-8000-000000000011', '00000000-0000-8000-8000-000000000012', 'results'),
    ('00000000-0000-8000-8000-000000000022', '00000000-0000-8000-8000-000000000001', '00000000-0000-8000-8000-000000000012', '00000000-0000-8000-8000-000000000013', 'results')
ON CONFLICT (id) DO NOTHING;
"""
